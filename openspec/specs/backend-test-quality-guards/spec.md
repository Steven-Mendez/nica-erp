...
boilerplate. Three Makefile lanes (`test-be-unit`,
`test-be-integration`, `test-be-e2e`) let contributors run the cheapest
layer first without paying the testcontainer boot cost.
